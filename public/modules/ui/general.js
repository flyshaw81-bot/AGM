...
function showInfo() {
  const Discord = "AGM community";
  const Reddit = "AGM Studio community";
  const Patreon = "AGM Studio funding";
  const Armoria = "AGM emblem tooling";
  const Deorum = "AGM character tooling";

  const QuickStart = link(
    "docs/Quick-Start-Tutorial",
    "Quick start tutorial"
  );
  const QAA = link("docs/Q&A", "Q&A page");
  const VideoTutorial = link("https://youtube.com/playlist?list=PLtgiuDC8iVR2gIG8zMTRn7T_L0arl9h1C", "Video tutorial");

  alertMessage.innerHTML = /* html */ `<b>AGM Studio</b> (AGM) is a free open-source application. It means that you own all created maps and can use them as
    you wish.
    ...
    <ul style="columns:2">
      <li>AGM Studio project tracker</li>
      <li>${link("LICENSE", "License")}</li>
      <li>AGM roadmap</li>
      <li>AGM hotkeys guide</li>
      <li>AGM governance channel</li>
    </ul>
