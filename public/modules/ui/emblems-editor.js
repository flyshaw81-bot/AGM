...
function editEmblem(type, id, el) {
  ...
  function openInArmoria() {
    tip("External coat-of-arms editor integration is not configured for AGM Studio yet", false, "warn");
  }
  ...
  async function downloadGallery() {
    ...
    function runDownload() {
      ...
      const AGM = `<a href="/AGM-Studio/" target="_blank">AGM Studio</a>`;
      const license = "AGM Studio asset license notes";
      const html = /* html */ `<!DOCTYPE html>
        <html>
          ...
          <body>
            ...
            <address>Generated by ${AGM}. The tool is free, but images may be copyrighted, see ${license}</address>
          </body>
        </html>`;
