...

{
  ...
  const latestPublicChanges = [
    ...
    "AGM Bot to answer questions and provide help",
  ...
  function showUpdateWindow() {
    ...
    const reddit = "https://www.reddit.com/r/AGMStudio";
    const discord = "https://discordapp.com/invite/X7E84HU";
    const patreon = "https://www.patreon.com/agm-studio";

    alertMessage.innerHTML = /* html */ `AGM Studio is updated up to version <strong>${VERSION}</strong>. This version is compatible with <a href="${changelog}" target="_blank">previous versions</a>, loaded save files will be auto-updated.
